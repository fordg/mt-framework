 ...
 *
 * @package    MT_Core
 * @subpackage MT_Core/admin/partials
 */
?>
<div id="colorpickerwrap" style="display:none">
	<div class="colorpickerwrap close">
		<header>
			<div class="cat-wrap">
				<select id="iconpicker-category" name="iconpicker-cat" class="widefat">
					<option value=""><?php esc_attr_e( 'All Categories', 'mtcore' ); ?></option>
					<option value="web-content"><?php esc_attr_e( 'Web Content', 'mtcore' ); ?></option>
					<option value="user-actions"><?php esc_attr_e( 'User Actions', 'mtcore' ); ?></option>
					<option value="message"><?php esc_attr_e( 'Messages', 'mtcore' ); ?></option>
					<option value="user-types"><?php esc_attr_e( 'User Types', 'mtcore' ); ?></option>
					<option value="gender"><?php esc_attr_e( 'Gender & Sexuality', 'mtcore' ); ?></option>
					<option value="layout"><?php esc_attr_e( 'Layout Adjustment', 'mtcore' ); ?></option>
					<option value="objects"><?php esc_attr_e( 'Objects', 'mtcore' ); ?></option>
					<option value="media"><?php esc_attr_e( 'Media', 'mtcore' ); ?></option>
					<option value="technologies"><?php esc_attr_e( 'Technologies', 'mtcore' ); ?></option>
					<option value="rating"><?php esc_attr_e( 'Rating', 'mtcore' ); ?></option>
					<option value="map"><?php esc_attr_e( 'Map', 'mtcore' ); ?></option>
					<option value="currency"><?php esc_attr_e( 'Currency', 'mtcore' ); ?></option>
					<option value="payment"><?php esc_attr_e( 'Payment Options', 'mtcore' ); ?></option>
					<option value="brands"><?php esc_attr_e( 'Brands', 'mtcore' ); ?></option>
				</select>
			</div>
			<div class="search-wrap" style="display:none">
				<input class="widefat" type="text" name="iconpicker-search" value="" placeholder="<?php esc_html_e('Search Icon...','mtcore'); ?>" readonly>
			</div>
		</header>
		<section id="iconlist">
		...
		<footer>
			<button type="button" class="button button-default" onclick="tb_remove()"><?php esc_html_e('Cancel','mtcore'); ?></button>
			<button id="pick-icon" type="button" class="pick-icon button button-primary"><?php esc_html_e('Select','mtcore'); ?></button>
		</footer>
	</div>
</div>
