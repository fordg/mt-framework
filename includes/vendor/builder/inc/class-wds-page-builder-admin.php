	...
	class WDS_Page_Builder_Admin {
		...
		public function load_admin_css( $hook ) {
			if ( in_array( $hook, array( 'post-new.php', 'post.php' ) ) &&
				...
				wp_enqueue_style( 'wds-simple-page-builder-admin', $this->directory_url . '/assets/css/admin.css', '', PAGEBUILDER_VERSION );
		...
		public function enqueue_builder_js() {
			wp_enqueue_script( 'wds-simple-page-builder', $this->directory_url . '/assets/js/builder.js', array( 'cmb2-scripts' ), PAGEBUILDER_VERSION, true );
		...
		public function limit_part_to_area( $options, $parts, $area ) {
			...
			if ( isset( $_GET['post_type'] ) && 'wds_pb_layouts' === $_GET['post_type'] ) {
				unset( $options[ 'saved-layout' ] );
				return $options;
			}
