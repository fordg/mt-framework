...
if ( ! class_exists( 'WDS_Page_Builder_Layouts' ) ) {
    ...
    public function settings_notices( $object_id, $updated ) {
      $id = $this->plugin->options->key . '_default_area_layouts';
   		if ( $object_id !== $id || empty( $updated ) ) {
   			return;
   		}
   		add_settings_error( $id . '-notices', '', __( 'Settings updated.', 'wds-simple-page-builder' ), 'updated' );
   		settings_errors( $id . '-notices' );
   	}
